...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/LynxBotList'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url="https://t.me/DCanimeindo",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/LynxBotList",
                            ),
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [
                        ...
                        InlineKeyboardButton(
                            text="Support", url="https://t.me/LynxBotList"
                        ),
                    ]
                )
                send_help(
